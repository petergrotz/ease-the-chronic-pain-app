  ...
  return (
    <div className="w-full">
      <div className="text-center mb-6">
        <h2 className="font-retro text-2xl font-semibold text-foreground mb-2">
                ...
                <CardContent className="p-0">
                  <div className="relative">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <h3 className="font-retro font-semibold text-white text-lg mb-1 drop-shadow-lg">
                        {environment.name}
                      </h3>
                      <p className="font-retro text-white/90 text-xs drop-shadow-md">
