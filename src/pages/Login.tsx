...
const Login = () => {
  ...
  // Prefetch Google OAuth URL to use a direct link (avoids iframe/popup blockers)
  useEffect(() => {
        ...
        <Card className="animate-in fade-in-50 slide-in-from-bottom-4 duration-700 delay-400">
          ...
          <CardContent className="space-y-4">
            {oauthUrl ? (
              ...
              >
                <a href={oauthUrl} target="_blank" rel="noopener noreferrer" aria-label="Continue with Google">
